...
if __name__ == "__main__":
    ...
    options['gripper_types'] = "PandaGripper"
    ...
    robot_states = np.loadtxt("/home/lawrence/xembody_followup/taco_play/robot_states.txt")
    joint_angles = robot_states[:, 7:-1]
    ee_poses = robot_states[:, :6]
    ...
    for k in range(len(joint_angles)):
        ...
        camera_wrapper.set_camera_fov(fov=70)
        ...
        # breakpoint()
        camera_pos_mirage = np.array([-0.03,-0.67,0.87])
        camera_rot_mirage = np.array([[   0.7582163, -0.3774976,  0.5316047],
        ...
        target_quat = T.mat2quat(T.euler2mat(target_pose[3:]))
