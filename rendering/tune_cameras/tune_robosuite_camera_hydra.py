...
if __name__ == "__main__":
    ...
    joint_angles = np.loadtxt("/home/lawrence/xembody_followup/mirage_data/joint_states.txt")
    ee_poses = np.loadtxt("/home/lawrence/xembody_followup/mirage_data/cartesian_positions.txt")
    ...
    for k in range(len(joint_angles)):
        ...
        # breakpoint()
        camera_pos_mirage = np.array([0.9,-0.1,0.55])
        camera_rot_mirage = np.array([[ 0.3579176,  0.3432538, -0.8683731],
