...
if __name__ == "__main__":
    ...
    joint_angles = np.loadtxt("/home/lawrence/xembody_followup/austin_sailor_dataset/joint_states.txt")
    ee_poses = np.loadtxt("/home/lawrence/xembody_followup/austin_sailor_dataset/ee_states.txt")
    ...
    for k in range(len(joint_angles)):
        ...
        # breakpoint()
        camera_pos_mirage = np.array([0.65,-0.25,0.65])
        camera_rot_mirage = np.array([[0.9145496,  0.3510393, -0.2009238],
        ...
        breakpoint()
        target_pose = ee_poses[k].reshape((4,4))
