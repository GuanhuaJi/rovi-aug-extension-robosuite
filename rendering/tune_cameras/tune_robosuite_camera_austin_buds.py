...
if __name__ == "__main__":
    ...
    joint_angles = np.loadtxt("/home/lawrence/xembody_followup/austin_buds_dataset/joint_states.txt")
    ee_poses = np.loadtxt("/home/lawrence/xembody_followup/austin_buds_dataset/ee_states.txt")
    ...
    for k in range(len(joint_angles)):
        ...
        # breakpoint()
        camera_pos_mirage = np.array([0.8,0.,0.7])
        camera_rot_mirage = np.array([[0.0000000,  0.93, -0.2],
