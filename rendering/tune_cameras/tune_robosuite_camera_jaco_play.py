...
if __name__ == "__main__":
    ...
    # doesn't work
    # joint_angles = np.loadtxt("/home/lawrence/xembody_followup/jaco_play_dataset/joint_states.txt")[:, :7]
    # ee_poses = np.loadtxt("/home/lawrence/xembody_followup/jaco_play_dataset/ee_states.txt")
    ...
    for k in range(len(joint_angles)):
        ...
        # breakpoint()
        camera_pos_mirage = np.array([0.9,0.,0.25])
        camera_rot_mirage = np.array([[0.0000000,  0.5, -0.6],
