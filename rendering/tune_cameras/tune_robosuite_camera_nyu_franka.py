...
if __name__ == "__main__":
    ...
    joint_angles = np.loadtxt("/home/lawrence/xembody_followup/nyu_franka_dataset/joint_states.txt")[100:]
    ee_poses = np.loadtxt("/home/lawrence/xembody_followup/nyu_franka_dataset/ee_states.txt")
    ...
    for k in range(len(joint_angles)):
        ...
        # breakpoint()        
        camera_pos_mirage = np.array([0.05,-0.15,0.7])
        camera_rot_mirage = np.array([[0.5, -0.1, 0.2],
                                    [-0.2, 0.1, 0.5],
                                    [0.0, -0.8, -0.6]])
