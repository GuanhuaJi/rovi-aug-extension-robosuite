...
if __name__ == "__main__":
    ...
    joint_angles = np.loadtxt("/home/lawrence/xembody_followup/toto_dataset/joint_states.txt")
    ee_poses = np.loadtxt("/home/lawrence/xembody_followup/toto_dataset/ee_poses.txt")
    ...
    for k in range(len(joint_angles)):
        ...
        camera_wrapper.set_camera_fov(fov=85)
        ...
        # breakpoint()
        camera_pos_mirage = np.array([0.35,-0.4,0.25])
        camera_rot_mirage = np.array([[ 0.9635627,  0.2064777, -0.1700405],
