...
class SourceEnvWrapper:
    ...
    def get_source_robot_states(self, save_source_robot_states_path="paired_images", reference_joint_angles_path=None, reference_ee_states_path=None, reference_gripper_states_path=None, episode=0):
        info = self._load_dataset_info(self.robot_dataset)
